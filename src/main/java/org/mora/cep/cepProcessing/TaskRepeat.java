...
//                String cloudsAll = cloudObject.get("all").toString();
                ...
                dataPublisher.publish(streamID, new Object[]{"127.0.0.1"}, null, new Object[]{Double.parseDouble(temperature), Double.parseDouble(pressure), Double.parseDouble(humidity), Double.parseDouble(windSpeed), Double.parseDouble(windDirection), Double.parseDouble(latitude), Double.parseDouble(longitude)});
            }
